...
void plotHist2D() {
  ...
  saveCanvas(c7, "files", "AbsoluteEfficiency_Pythia_NoPU_TuneCP5_QCD_ptHat15_NoTrigger_5p36TeV_ptResoAfterpT10GeV");
  ...
  saveCanvas(c8, "files", "MultipleReconstruction_Pythia_NoPU_TuneCP5_QCD_ptHat15_NoTrigger_5p36TeV_ptResoAfterpT10GeV");
  ...
  saveCanvas(c9, "files", "FakeRate_Pythia_NoPU_TuneCP5_QCD_ptHat15_NoTrigger_5p36TeV_ptResoAfterpT10GeV");
//  c9->GetPad(2)->SetLogx();
  ...
  saveCanvas(c10, "files", "SecondaryReconstruction_Pythia_NoPU_TuneCP5_QCD_ptHat15_NoTrigger_5p36TeV_ptResoAfterpT10GeV");

  TFile *fout = new TFile("files/Recreate_Pythia_NoPU_TuneCP5_QCD_ptHat15_NoTrigger_5p36TeV_ptResoAfterpT10GeV.root","RECREATE");
